...
global L1 L2 L3 NinputANDoutput connectivity Nbeams Nlayers mymap2 Ncolorstep DOI Kaxial dx coord_initial Plot_exaggerate Outputline Plot_cmap maxStiffness minStiffness
if nargin <9
    c = 1;
end
beamThickness = 8.5;
